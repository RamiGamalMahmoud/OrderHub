...
public record ShipOrderCommand(int OrderId) : IChangeOrderStatusCommand;

internal class ShipOrderCommandHandler : IRequestHandler<ShipOrderCommand, Result<OrderStatus>>
{
    ...
    public async Task<Result<OrderStatus>> Handle(ShipOrderCommand request, CancellationToken cancellationToken)
    {
