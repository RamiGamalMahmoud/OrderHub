...
internal class CreateOrderCommandHandler(AppDbContextFactory appDbContextFactory) : IRequestHandler<CreateOrderCommand, Result>
{
    ...
    public async Task<Result> Handle(CreateOrderCommand request, CancellationToken cancellationToken)
    {
        ...
        {
            OrderItem orderItem = new OrderItem(orderItemDto.ProductId, orderItemDto.ProductName, 0, orderItemDto.UnitPrice, orderItemDto.Quantity);
