...
internal class ProformaInvoiceTableComponent : IComponent
{
    private readonly ProformaInvoicePdfData _data;

    public ProformaInvoiceTableComponent(ProformaInvoicePdfData data)
    {
        _data = data;
    }
