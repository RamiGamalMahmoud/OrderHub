...
namespace OrderHub.Infrastructure.Migrations
{
    ...
    [Migration("20260826142134_CreateNewOutboxMessageAttachments")]
    partial class CreateNewOutboxMessageAttachments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderHub.Domain.Models.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("OrderHub.Domain.Models.InvoiceItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_invoices_item");

                    b.HasIndex("InvoiceId")
                        .HasDatabaseName("ix_invoices_item_invoice_id");

                    b.HasIndex("ProductId")
                        .HasDatabaseName("ix_invoices_item_product_id");

                    b.ToTable("invoices_item", (string)null);
                });
            ...
            modelBuilder.Entity("OrderHub.Domain.Models.OutboxMessageAttachment", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_outbox_message_attachments");

                    b.HasIndex("OutboxMessageId")
                        .HasDatabaseName("ix_outbox_message_attachments_outbox_message_id");

                    b.ToTable("OutboxMessageAttachments", (string)null);
                });
            ...
            modelBuilder.Entity("OrderHub.Domain.Models.Invoice", b =>
                {
                    b.HasOne("OrderHub.Domain.Models.Order", "Order")
                        .WithOne()
                        .HasForeignKey("OrderHub.Domain.Models.Invoice", "OrderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("OrderHub.Domain.Models.InvoiceItem", b =>
                {
                    b.HasOne("OrderHub.Domain.Models.Invoice", "Invoice")
                        .WithMany("Items")
                        .HasForeignKey("InvoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_invoices_item_invoices_invoice_id");
                    ...
                    b.HasOne("OrderHub.Domain.Models.Product", "Product")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_invoices_item_products_product_id");
            ...
            modelBuilder.Entity("OrderHub.Domain.Models.OutboxMessageAttachment", b =>
                {
                    b.HasOne("OrderHub.Domain.Models.OutboxMessage", "OutboxMessage")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_outbox_message_attachments_outbox_messages_outbox_message_id");
